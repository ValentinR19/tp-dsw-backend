...
export type ListQuery = {
  ...
  orderBy?: 'id' | 'name' | 'color' | 'createdAt' | 'updatedAt';
  order?: 'ASC' | 'DESC';
};
...
export class CustomerStatusRepository {
  ...
  create(payload: Partial<CustomerStatus>): CustomerStatus {
    return this.repo.create(payload);
  }

  save(entity: CustomerStatus): Promise<CustomerStatus> {
    return this.repo.save(entity);
  }

  findById(id: number, includeDeleted = false): Promise<CustomerStatus | null> {
